...
// to avoid warnings about SSR and Quill
// import dynamic from "next/dynamic";
const ReactQuill = dynamic(() => import("react-quill-new"), { ssr: false });

const CreateArticlesPages = () => {
    const [content, setContent] = useState("");
    // we can also send content state to the action by createArticle(content) in useActionState
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        // we use this because we are ading content (an extra state)
        startTransition(() => {
            action(formData);
        });
    }    
...
export default CreateArticlesPages;